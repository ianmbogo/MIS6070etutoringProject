...
<html>
    ...
    ?>
  <form action="php/postBlog.php" method="POST">
      <input type="text" name="topic" placeholder ="heading of your blog" required>
      Note: You can add HTML tags to me your blog look nice to readers. 
      <textarea name="text" required placeholder="Type the blog details"></textarea>
      
      
      <br>
     
     
       <input type ="submit" name="post" class="button big alt" style="border:1px solid black;" value="Post now" required><br>
