...
if(!isset($_GET['recipient']) ||isset($_GET['recipient']) == ''){
...
header('location:dashboard.php?error=Recipient doesnot exist.');
}
?>
<!DOCTYPE HTML>
<html>
		...
		<!-- Main -->
			<div id="preview" class="vertical" style="border:2px solid gray; width:70%; margin:auto; border-radius:25px;">
				...
				<div class="inner">
					...
					<div class="image fit">
					    <hr>
					    <h2>Send message to <?php echo $_GET['recipient']; ?></h2>
						 <?
    //check for errors
  ...
  <form action="php/send_message.php" method="POST">
      <input type ="text" name="recipient" value="<?php echo $_GET['recipient']; ?>" readonly><br>
     
      
      <textarea name="text" required placeholder="Type the message"></textarea>
      
      
      <br>
     
     
       <input type ="submit" name="send" class="button big alt" style="border:1px solid black;" value="Send now" required><br>
