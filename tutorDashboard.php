		...
		<!-- Main -->
			<div id="preview" class="vertical" style="border:2px solid gray; width:70%; margin:auto; border-radius:25px;">
				...
				<div class="inner">
					...
					<div class="image fit">
					    <hr>
<h1>Tutor <?php echo $_GET['tutor'].'\'s details'; ?></h1>
    <?
...
';
$this_tutor = $_GET['tutor'];
   $sqluser = "SELECT * FROM users WHERE username = '$this_tutor'";
...
if ($resultuser->num_rows > 0) {
  ...
  $those_alloted = $row['allocated_students'];
	...
	<tr>
		...
		<td>Number of alloted students: '.$allocated_students.'</a>
	...
	<tr>
	<td><h2>Allocated students</h2></td>
	</tr>
	<tr>
	<td>
	...
	<a href="allot.php?tutor='.$username.'">
	<hr>
	
	
	<button>Allocate more</button></a>
